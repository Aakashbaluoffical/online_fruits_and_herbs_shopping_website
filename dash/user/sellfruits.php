  ...
  <div class="all-title-box">
    ...
    <!-- End All Title Box -->
          ...
          if(isset($_POST['btnsave'])){
            ...
            $fea=$_POST['fea'];
            $cost=$_POST['cost'];
            $ins="insert into tb_fruits(fruitname,fruitdes,fruitfea,fruitcost) values('".$name."','".$desc."','".$fea."','".$cost."')";
            //echo $ins;
              ...
              ?>
                       ...
                       <form method="POST">
                        <div class="form-group">
                           <input type="text" name="name" class="form-name" placeholder="fruit Name">
                         </div>
                           <div class="form-group">
                             <textarea name="desc"  cols="30" rows="7" class="form-desc" placeholder="fruit Description"></textarea>
                           </div>
                              <div class="form-group">
