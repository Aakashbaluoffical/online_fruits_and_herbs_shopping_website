   ...
   // echo "<script>alert('".$_SESSION['sid']."');</script>";
    if($_GET['fid']){
        ...
        if($_SESSION['sid']==""){
            ...
            $chead_id="";
            $cdetail_id="";
            $self="select * from tb_fruits where fruit_id='".$_GET['fid']."'";
            ...
            if($num > 0){
                ...
                $sel="select * from tb_cart_head where user_id='".$_SESSION['sid']."' and cart_head_date=CURDATE() and cart_head_status='active' order by cart_head_id desc limit 1";
                $row=mysqli_query($con,$sel);
                $num=mysqli_num_rows($row);
                if($num > 0){
                    $data=mysqli_fetch_array($row);
            ...
            $sel2="select * from tbl_cart_details where cart_head_id='".$chead_id."' and product_id='".$_GET['fid']."' and product_type='fruit'";
            ...
            if($num2 > 0){
                ...
                $ins="insert into tbl_cart_details(cart_head_id,product_id,product_type,product_qty,product_unit_pice,image) values('".$chead_id."','".$_GET['fid']."','fruit','1','".$dataf['fruitcost']."','".$dataf['image']."')";
                mysqli_query($con,$ins);
            }
                    ...
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                ...
                                <a class="cart" href="fruits.php?fid=<?php echo $data['fruit_id']; ?>" >Add to Cart<i name="cartid"></i></a>
                            </div>
                        </div>
                        <div class="why-text">
			            <h4><?php echo $data['fruitname']; ?></h4>
                            <h5>&#8377;&nbsp<?php echo $data['fruitcost']; ?></h5>
